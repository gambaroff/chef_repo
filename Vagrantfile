...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "sloniki-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/public_void"
  #   chef.validation_client_name = "public_void-validator"
  #   chef.validation_key_path = ".chef/public_void-validator.pem"
  # end
end
